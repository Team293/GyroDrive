...
public class Vision {
    ...
    public static double centerOfGravity() { //Only COG_X is required to center the robot
        double centerOfGravity = cameraTable.getNumber("COG_X", 120); //120 as default, so nothing will happen if no value is acquired from smartdashboard
    ...
    public static double calculateAngle() {//This is an best fit line generated from a table of values with excel
        ...
        SmartDashboard.putNumber("distanceOnFloor", d);
